...
: ${AMENT_CURRENT_PREFIX:="/root/ros2_ws/install/my_diff_robot"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_diff_robot/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/my_diff_robot/environment/path.sh"
